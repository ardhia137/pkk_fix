            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            <a href="data_admin" class="nav-link active">
                            ...
                            Tambah admin
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach($admin as $b)
                                        <tr>
                                            <td data-toggle="modal" data-target="#edit" id="editAdmin"
                                            ...
                                            <td><a href="{{ route('admin.hapus_admin',$b->id) }}"
                                                    class="btn btn-danger " style="font-size: 0.8em;"
                                                    id="hapus" data-id="{{ $b->id }}">
                                                    Hapus
                                                </a>
                                                <a href="{{ route('admin.cps_admin',$b->id) }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click', '#editAdmin', function (event) {
                ...
                var id = $(this).data('id');
                console.log(id)
                $.get('data_admin/edit/' + id, function (data) {
                    $('#userCrudModal').html("Edit admin");
                    $('#submit').val("Edit admin");
                    $('#edit').modal('show');
                    $('#id').val(data.data.id);
